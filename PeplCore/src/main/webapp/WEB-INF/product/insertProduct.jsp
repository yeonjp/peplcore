					...
					<form action="insertProduct.pc" method="post"
						...
						<div class=" mb-3 col-md-4 mx-auto">
							<label for="inputEmail">상품번호</label> <input type="text"
								name="pseq" readonly="readonly" value="${pseq }"
								class="form-control" />
						</div>
						<div class=" mb-3 col-md-4 mx-auto">
							<label for="inputEmail">상품분류</label><br> <select
								name="pcategory" id="pcategorySelect"
						...
						<div class=" mb-3 col-md-4 mx-auto">
							<label for="inputEmail">상품 수량</label> <input type="text"
								name="pnum" value="0" class="form-control" />
						</div>
						<div class=" mb-3 col-md-4 mx-auto">
							<label for="inputEmail">상품 품절 여부</label><br> <select
								name="poutStock" id="poutStock" class="col-lg-12 text-center">
						...
						<div class=" mb-3 col-md-4 mx-auto">
							<label for="inputEmail">상품 사이즈</label> <input type="text"
								name="psize" readonly="readonly" value="FREE"
								class="form-control" />
						</div>
						<div class=" mb-3 col-md-4 mx-auto">
							<label for="inputEmail">상품 원가</label> <input type="text"
								name="pcost" value="0" class="form-control" />
						</div>
						<div class=" mb-3 col-md-4 mx-auto">
							<label for="inputEmail">상품 판매가</label> <input type="text"
								name="pselling" value="0" class="form-control" />
						</div>
						<div class=" mb-2 text-center">
							<label for="inputEmail">상품 설명</label><br>
							<textarea name="pdescription" cols="60" rows="10"
								placeholder="내용을 입력해 주세요."></textarea>
						</div>
						<div class="text-center">
							<input type="submit" name="insertProduct" class="btn btn-primary me-3"
								value="등록완료" id="registerBtn"></input> 
								<button type="button"
								name="cancleProduct" class="btn btn-danger text-white" value="등록취소"
								onclick="location.href='productManagement.pc'">등록취소</button>
						</div>
					</form>
					<!-- //수정 form -->
				</div>

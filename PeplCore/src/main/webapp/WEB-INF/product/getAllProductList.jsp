				...
				<div class="mainNav">
					<form action="insertProductView.pc" method="post">
						<ul>
							...
							<li><input type="submit" name="insertProduct"
								class="insertBtn" value="상품등록"></input></li>
						</ul>
					</form>
				</div>
				<hr />
...
<!-- 							<td><input type="button" name="showProduct" class="showBtn" value="상품보기" onclick="location.href='getOneProduct.pc'"></td> -->
							<%-- <td><input type="button" name="insertProduct" class="insertBtn1" value="상품수정" onclick="location.href='updateProduct.pc'"></td>
							<td><input type="button" name="deleteProduct" class="deleteBtn" value="상품삭제" onclick="deleteProduct(${product.getPseq()})"></td>
							<td><input type="button" name="showProduct" class="showBtn" value="상품보기" onclick="location.href='getOneProduct.pc'"></td> --%>
							<!-- <input type="button" name="insertProduct" class="insertBtn" value="상품등록" onclick="location.href='insertProductView.pc'"> -->
						</tr>
					</c:forEach>
				</table>
			</div>
...
<script type="text/javascript">
    function deleteProduct(pseq) {
        location.href = 'deleteProduct.pc?pseq='+pseq;
    }
</script>
</body>
</html>
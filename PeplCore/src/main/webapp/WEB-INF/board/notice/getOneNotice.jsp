	...
	<%-- <form action="" method="post" >--%> 
		...
		<%-- <input type="button" value="목록" onclick="location.href='getAllFAQlist.bc'"> 	--%>
			...
			<tr>
				<td>작성일자</td>
				<td>
					<input type="text" name="bdate" value="${notice.getBdate()}" readonly>
				</td>
			</tr>
			...
			<tr>
				<td>제목</td>
				<td>
					<input type="text" name="btitle" value="${notice.getBtitle()}" readonly>
				</td>
			</tr>
			...
			<tr>
				<td>내용</td>
				<td>
					<textarea readonly>${notice.getBcontent()}</textarea>
				</td>
			</tr>
			</table>

		...
		<div id="layoutSidenav_content">
			...
			<main style="background-color: #edf0f2 !important;">
				<div class="container mx-auto mt-5">
					...
					<hr>
					<!-- 수정 form -->
					<form action="getAllNotice.bc" method="post"
						class="border p-3 col-xl-11 mx-auto">

						<div class=" mb-3 col-md-4 mx-auto">
							<label for="inputEmail">글번호</label> <input type="text"
								name="bseq" value="${notice.getBseq()}" class="form-control"
								readonly>

						</div>
						<div class=" mb-3 col-md-4 mx-auto">
							<label for="inputEmail">작성일자</label> <input type="text"
								name="bdate" value="${notice.getBdate()}" class="form-control"
								readonly>
						</div>

						<div class=" mb-3 col-md-4 mx-auto">
							<label for="inputEmail">제목</label> <input type="text"
								name="btitle" value="${notice.getBtitle()}" readonly>
						</div>

						<div class=" mb-3 col-md-4 mx-auto">
							<label for="inputEmail">작성자</label> <input type="text" name="bid"
								value="${notice.getBid()}" class="form-control" readonly>
						</div>

						<div class=" mb-3 col-md-4 mx-auto">
							<label for="inputEmail">작성 내용</label>
							<textarea cols="60" rows="10" readonly>${notice.getBcontent()}</textarea>
						</div>

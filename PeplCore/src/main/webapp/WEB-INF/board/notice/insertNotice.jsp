		...
		<div id="layoutSidenav_content">
			...
			<main style="background-color: #edf0f2 !important;">
				<div class="container mx-auto mt-5">
					...
					<hr>
					<!-- 수정 form -->
					<form action="insertNotice.bc" method="post"
						class="border p-3 col-xl-11 mx-auto">


						<div class=" mb-3 col-md-4 mx-auto">
							<label for="inputEmail">글번호</label> <input type="text"
								name="bseq" value="${maxSeq}" class="form-control" readonly>
						...
						<div class=" mb-3 col-md-4 mx-auto">
							<label for="inputEmail">제목</label> <input type="text"
								name="btitle" class="form-control">
						</div>

						<div class=" mb-3 col-md-4 mx-auto">
							<label for="inputEmail">작성자</label> <input type="text" name="bid" class="form-control">
						</div>
						
						
						<div class=" mb-2 text-center">
							<label for="inputEmail">내용</label><br>
							<textarea name="bcontent" cols="80" rows="10"
								placeholder="공지사항을 입력해 주세요."></textarea>
						</div>
						<div class="text-center">
							<input type="submit" name="insertProduct"
								class="btn btn-primary me-3" value="등록완료" id="registerBtn"></input>
							<button type="button" name="cancleProduct"
								class="btn btn-danger text-white" value="등록취소"
								onclick="location.href='getAllNotice.bc'">등록취소</button>
						</div>
					</form>
					<!-- //수정 form -->
				</div>

...
<%@page import="com.peplcore.blogic.board.FAQDAO"%>
<%@page import="com.peplcore.blogic.board.FAQDTO"%>
...
<h4>FAQ등록</h4>
<form action="insertFAQ.bc" method="post">
		<table>
			<tr>
				<td class="tdTitle">글번호</td>
				<td class="tdContent">
					<input type="text" name="bseq" value="${maxSeq}" readonly>
				</td>
			</tr>
			
			<tr>
				<td class="tdTitle">질문</td>
				<td class="tdContent">
			...
			<tr>
				<td class="tdSubmit" colspan="2">
							<%-- <input type="submit" value="등록" onclick="location.href='insertFAQ.bc'"> --%>	
					<input type="submit" value="등록" /> 
					<input type="button" value="목록" onclick="location.href='/WEB-INF/board/FAQ/getAllFAQList.jsp'" /> 
				</td>
			</tr>

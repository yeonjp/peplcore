...
<h4>FAQ수정</h4>
	 <form action="updateFAQ.bc" method="post"> 
		<table>
			<tr>
				<th class>글번호</td>
				<td class>
					<input type="text" name="bseq" value="${faq.getBseq()}" readonly>
				</td>
			</tr>
			...
			<tr>
				<th>질문</td>
				<td>
					<input type="text" name="btitle" value="${faq.getBtitle()}">
				</td>
			</tr>
			...
			<tr>
				<th>작성자</td>
				<td >
					<input type="text" name="bid" value="${faq.getBid()}" readonly>
				</td>
			</tr>
			...
			<tr>
				<th>내용</td>
				<td>
					<textarea name="bcontent">${faq.getBcontent()}</textarea>
				</td>
			</tr>

			<tr>
				<td colspan="2">
				<input type="submit" name="faq" value="수정">
					<%--  <a href="updateFAQ.bc?bseq=${faq.getBseq() }">수정</a> --%>
					<a href="getAllFAQList.bc">목록</a>

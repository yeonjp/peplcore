...
<h4>FAQ 상세보기</h4>
	<%-- <form action="" method="post" >--%> 
		...
		<%-- <input type="button" value="목록" onclick="location.href='getAllFAQlist.bc'"> 	--%>
			<tr>
			...
			<tr>
				...
				<td class="tdContent">
					<input type="text" name="btitle" value="${faq.getBtitle()}" readonly>
				</td>
			</tr>
			...
			<tr>
				...
				<td class="tdContent tdTextarea">
					<textarea name="bcontent" readonly>${faq.getBcontent()}</textarea>
				</td>
			</tr>
			</table>
